...
- Mudo/desmudo, ligar/desligar câmera
...
git init
git add .
git commit -m "AngelCord inicial"
git branch -M main
git remote add origin https://github.com/SEU-USUARIO/angelcord.git
...
5. Em "Environment", adicione a variável `SITE_PASSWORD` se quiser trocar
   a senha (opcional)
6. Deploy. Você recebe uma URL tipo `https://angelcord.onrender.com`
